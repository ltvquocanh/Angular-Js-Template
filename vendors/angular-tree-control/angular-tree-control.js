                ...
                controller: ['$scope', '$templateCache', '$interpolate', 'treeConfig', function( $scope, $templateCache, $interpolate, treeConfig ) {
                    ...
                    if(!template) {
                        template =
                            ...
                            'set-node-to-data>' +
                            '<div ng-mouseover="node.onHovering =true; $event.stopPropagation();" ng-mouseleave="node.onHovering =false; $event.stopPropagation();" ><i class="tree-branch-head" ng-class="iBranchClass()" ng-click="selectNodeHead(node)"></i>' +
                            '<i class="tree-leaf-head {{options.iLeafClass}}"></i>' +
                            '<div  class="tree-label {{options.labelClass}}" ng-class="[selectedClass(), unselectableClass()]" ng-click="selectNodeLabel(node)" tree-transclude></div></div>' +
